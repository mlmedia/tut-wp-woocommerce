...
function ecommerce_storefront_submenu_page_callback() {
 ?>
	<div class="wrap" >
        ...
        <p><?php echo esc_html__('Install YITH WishList and YITH Compare plugins.', 'ecommerce-storefront'); ?> </p>
		...
		<h3><?php echo esc_html__('Add Hero Content :-', 'ecommerce-storefront'); ?></h3>
