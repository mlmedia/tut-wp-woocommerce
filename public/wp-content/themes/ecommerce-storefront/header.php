...
<header id="masthead" class="site-header  site-header-background" role="banner" >
	...
	($new_york_business_option['contact_section_phone']!='' || $new_york_business_option['contact_section_email']!='' || $new_york_business_option['contact_section_address']!='' || $new_york_business_option['contact_section_hours']!='' 
	||  ($new_york_business_option['social_facebook_link']!='') || ($new_york_business_option['social_twitter_link']!='') || ($new_york_business_option['social_skype_link']!='') || ($new_york_business_option['social_pinterest_link']!='') )): ?>	      
